            ...
            <div class="d-flex flex-lg-row-fluid w-lg-50 bgi-size-cover bgi-position-center order-1 order-lg-2" style="background-image: url(assets/media/misc/auth-bg.png)">
                ...
                <div class="d-flex flex-column flex-center py-7 py-lg-15 px-5 px-md-15 w-100">
                    ...
                    <a href="../../demo1/dist/index.html" class="mb-0 mb-lg-12">
                        <img alt="Logo" src="{{ asset('images/logo2.png') }}" class="h-80px h-lg-75px" style="width: 150px; height: 200px;"/>
                    </a>
                    <!--end::Logo-->
                    <!--begin::Image-->
                    <img class="d-none d-lg-block mx-auto w-275px w-md-50 w-xl-500px mb-10 mb-lg-20 rounded-4" src="{{ asset('images/bg-youtube.png') }}" alt="Web Development Army Logo" />
                    <!--end::Image-->
                    <!--begin::Title-->
                    <h1 class="d-none d-lg-block text-white fs-2qx fw-bolder text-center mb-7">Web Development Army</h1>
                    <!--end::Title-->
                    <!--begin::Text-->
                    <div class="d-none d-lg-block text-white fs-base text-center">
                        Welcome to the Web Development Army Community, <br>
                        a dynamic and vibrant gathering place for web development enthusiasts and professionals alike.

                        <br>
                        We're excited to have you here! Login to get started.
