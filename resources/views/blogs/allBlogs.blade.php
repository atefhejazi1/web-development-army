	...
	<table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
		...
		<tbody>
			...
			<tr>
				...
				<td><img width="150px" height="150px" src="{{'images/blogs/' . $blog->blog_image}}" alt=""></td>
				<!-- <td>{{$blog->id_blog}}</td> -->
				<td><span class="badge badge-info">{{$blog->department->name}}</span></td>
				<td><span class="badge badge-danger">{{$blog->author}}</span></td>
				...
				<td>
					<div class="d-flex justify-content-start flex-shrink-0">
						...
						<a href="{{ url('/blogs/' . $blog->id .'/edit') }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
						...
						<form action="{{ route('blogs.destroy' ,  $blog->id ) }}" method="post" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
							@method('DELETE')
							@csrf
